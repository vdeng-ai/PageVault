/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false src/worker-configuration.d.ts` (hash: d1037b020346a4a5080ac40d0ac51261)
// Runtime types generated with workerd@1.20260701.1 2026-07-05 nodejs_compat
interface __BaseEnv_Env {
	HTML_BUCKET: R2Bucket;
	DB: D1Database;
	pagevault_db: D1Database;
	ASSETS: Fetcher;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_HTML_CACHE_SECONDS" | "ACCESS_COUNT_FLUSH_SECONDS" | "ACCESS_COUNT_MODE" | "APP_ENV" | "PUBLIC_BASE_URL" | "ADMIN_BASE_URL" | "DEFAULT_URL_EXPIRE_DAYS" | "DEFAULT_FILE_EXPIRE_DAYS" | "MAX_UPLOAD_SIZE_MB" | "ADMIN_EMAIL" | "ADMIN_PASSWORD_HASH" | "SESSION_SECRET">> {}
}
